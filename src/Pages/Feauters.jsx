...
export default function Feauters() {
  return (
    ...
    <div className="text-center">
      <h2 className="text-4xl font-semibold text-gray-800 mb-6">Featured Divisions</h2>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-8 rounded-lg shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-2xl">
        ...
        <div className="bg-gradient-to-r from-green-500 to-teal-600 p-8 rounded-lg shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-2xl">
        ...
        <div className="bg-gradient-to-r from-yellow-500 to-red-600 p-8 rounded-lg shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-2xl">
      ...
      <div className="mt-12 text-center">
        <h3 className="text-3xl font-semibold text-gray-800 mb-6">Support More Divisions</h3>
        <p className="text-lg text-gray-700 mb-8">
