...
export default function CompaingsCard({cloth}) {
  ...
  return (
    <div className=''>
    <div className="card bg-base-100 w-full h-[620px]  shadow-xl ">
      ...
      <div className="card-body">
        ...
        <p><span className='text-xl  text-blue-500 font-bold'>Division:</span> <span className='text-gray-500 font-bold'>{division}</span></p>
